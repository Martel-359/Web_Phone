...
INSERT INTO `loai_hang_hoa` (`ma_hang_hoa`, `Ten_loai`) VALUES
(1, 'Laptop'),
(2, 'SamSung'),
(3, 'iPhone');
...
CREATE TABLE `hang_hoa` (
  ...
  `id_loai` int(11) NOT NULL, FOREIGN KEY  REFERENCES loai_hang_hoa(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


INSERT INTO `hang_hoa` (`id`, `Ten_hang_hoa`, `name_search`, `gia`, `so_luong_hang`, `hinh`, `mo_ta`, `id_loai`, `lvproduct`) VALUES
...
(9, 'Điện thoại iPhone 11 Pro 256GB', 'Điện-thoại-iPhone-11-Pro-256GB', 31900000, 26, 'public/uploads/ip11pr.jpg', 'mo_ta', 5,
(12, 'Laptop HP Envy 13 ba0046TU i5 1035G4/8GB/512GB/Office H&S2019/Win10 (171M7PA)', 'Laptop-HP-Envy-13-ba0046TU-i5-1035G4-8GB-512GB-Office-H-S2019-Win10-(171M7PA)', 22900000, 19, 'public/uploads/hp-envy-13-ba0046tu-i5-171m7pa-225859-600x600.jpg', 'mo_ta', 1),
(13, 'Laptop Asus VivoBook Gaming F571GT i7 9750H/8GB/512GB/120Hz/4GB GTX1650/Win10 (AL858T)', 'Laptop-Asus-VivoBook-Gaming-F571GT-i7-9750H-8GB-512GB-120Hz-4GB-GTX1650-Win10-(AL858T)', 24490000, 18, 'public/uploads/asus-vivobook-gaming-f571gt-i7-al858t-226256-600x600.jpg', 'mo_ta', 1),
(14, 'Laptop Lenovo IdeaPad Slim 3 15IIL05 i3 1005G1/4GB/512GB/Win10 (81WE003RVN)', 'Laptop-Lenovo-IdeaPad-Slim-3-15IIL05-i3-1005G1-4GB-512GB-Win10-(81WE003RVN)', 25000000, 5, 'public/uploads/lenovo-ideapad-3-15iil05-i3-81we003rvn-013920-053901-600x600.jpg', 'mo_ta',1);
